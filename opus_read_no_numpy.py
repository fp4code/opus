...
fil    index: bloc position in Opus file
    ...
    return(blocs, params_dict, data_dict, unclassified_dict, reste)
...
for filename in glob.glob('/home/fab/Z/Fabrice/2015-10-21_murs/*.0'):
    print('')
    print(filename)
    try:
        blocs, params_dict, data_dict, unclassified_dict, reste = opus_read(filename)
        opus_print(blocs, params_dict, data_dict, unclassified_dict)
        if (reste != ''):
            print('$$$ REMAINING ' + str(len(reste)) + ' bits : ' + reste)
